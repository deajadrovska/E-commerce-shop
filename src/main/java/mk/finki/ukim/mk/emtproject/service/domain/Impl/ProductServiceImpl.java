...
public class ProductServiceImpl implements ProductService {
    ...
    public Optional<Product> update(Long id, Product product) {
        return productRepository.findById(id)
                .map(existingProduct -> {
                    ...
                    if (product.getManufacturer() != null && manufacturerService.findById(product.getManufacturer().getId()).isPresent()) {
    ...
    public Optional<Product> save(Product product) {
        if (product.getCategory() != null &&
                categoryService.findById(product.getCategory().getId()).isPresent() &&
                product.getManufacturer().getId() != null &&
                manufacturerService.findById(product.getManufacturer().getId()).isPresent()) {
            return Optional.of(
